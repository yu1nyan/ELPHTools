        ...
        for (int x = 0; x < 16; x++) {
            for (int y = 0; y < 16; y++) {
                ...
                if (x <= 3 || x >= 13 || y <= 3 || y >= 13) {
                    ...
                    hPE_cell_all[x][y]->Fit("landau_orig", "", "", allpeak[x][y] - 8, allpeak[x][y] + 8);
                    hPE_cell_x[x][y]->Fit("landau_orig", "", "", xpeak[x][y] - 8, xpeak[x][y] + 8);
                    hPE_cell_y[x][y]->Fit("landau_orig", "", "", ypeak[x][y] - 8, ypeak[x][y] + 8);
                    hPE_cell_z[x][y]->Fit("landau_orig", "", "", zpeak[x][y] - 8, zpeak[x][y] + 8);
                }
